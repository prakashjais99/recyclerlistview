...
export declare abstract class BaseDataProvider {
    ...
    getLastIndexToProcessInternal(): number;
    cloneWithRows(newData: any[], firstModifiedIndex?: number, lastModifiedIndex?: number): DataProvider;
}
